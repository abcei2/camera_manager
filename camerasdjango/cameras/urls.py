...
from cameras.views import (
    CamListView, delete_camera, CamCreateView, create_new_camera,
...
urlpatterns = [
    ...
    path(
        'new_camera/create_new_camera/',
        create_new_camera, {},
        name='create_new_camera'
    ),
    ...
    url(r'^manage_cameras/delete_camera/$',
        delete_camera, name='delete_camera'),
]
